...
if __package__ is None or __package__ == "":
    # Allows running as `python v1/bot.py` (otherwise `import v1...` fails because sys.path[0] is `v1/`)
...
from v1.search import get_product_by_id
from v1.router import route_user_message
from v1.filters import Filters, parse_budget_usd, parse_size_range, parse_size_token
from v1.search import search_products_filtered
from v1.tools import tool_brand_options_for_query
from v1.search import normalize_query
